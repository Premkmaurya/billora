...
import { FileText, UserPlus, AlertTriangle, CheckCircle2 } from 'lucide-react';
...
export const RecentActivityList: React.FC<RecentActivityListProps> = ({ activities = [] }) => {
  ...
  const sampleActivities: RecentActivity[] = activities.length > 0 ? activities : [
    {
      id: '1',
      type: 'INVOICE_CREATED',
      title: 'Invoice #INV-0984 Created',
      description: '₹1,450 paid via UPI Scan & Pay by Suresh Kumar',
    ...
    },
    {
      ...
      description: 'LED Bulbs & Lamps reached 3 units minimum safety level',
    ...
    },
    {
      ...
      description: 'Priya Sharma (+91 98765 12345) added to directory',
      timestamp: new Date(Date.now() - 7200000).toISOString(),
    },
    {
      id: '4',
      type: 'PAYMENT_RECEIVED',
      title: 'Outstanding Due Received',
      description: '₹500 cleared for Invoice #INV-0920 by Cashier',
