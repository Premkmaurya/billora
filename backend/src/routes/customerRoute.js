...
router.get("/:id/invoices", protect, customerController.getCustomerInvoices);
router.get("/:id/outstanding", protect, customerController.getCustomerOutstanding);
...
router.post("/import", protect, authorizeRoles("owner", "manager"), customerController.importCustomers);
